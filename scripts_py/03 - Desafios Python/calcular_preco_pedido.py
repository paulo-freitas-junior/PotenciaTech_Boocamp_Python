...
print('O preço final do pedido é R$ {:.2f}. Seu troco é R$ {:.2f}.'.format(valorHamburguer * quantidadeHamburguer + valorBebida * quantidadeBebida, valorPago - (valorHamburguer * quantidadeHamburguer + valorBebida * quantidadeBebida)))
